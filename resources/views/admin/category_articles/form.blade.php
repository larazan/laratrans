        ...
        <div class="col-lg-6">
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($category))
                        {!! Form::model($category, ['url' => ['admin/category_article', $category->id], 'method' => 'PUT']) !!}
                        {!! Form::hidden('id') !!}
                    @else
                        {!! Form::open(['url' => 'admin/category_article']) !!}
                    @endif
                        ...
                        <div class="form-footer pt-5 border-top">
                            ...
                            <a href="{{ url('admin/category_article') }}" class="btn btn-secondary btn-default">Back</a>
                        </div>
                    {!! Form::close() !!}
                </div>
            </div>  
